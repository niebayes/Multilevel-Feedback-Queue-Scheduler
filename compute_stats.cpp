...
class Stats {
 ...
 public:
  Stats();
  bool compute_scheduling_stats(std::ifstream &results_file,
                                std::vector<Customer> &customers);
  void print();
};

void read_customer_info(std::ifstream &in_file,
                        std::vector<Customer> &customers) {
  std::string name;
...
bool Stats::compute_scheduling_stats(std::ifstream &results_file,
                                     std::vector<Customer> &customers) {
